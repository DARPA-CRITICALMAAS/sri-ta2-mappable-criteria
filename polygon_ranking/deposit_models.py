systems_dict = {
    ...
    'mvt_zinc_lead': {
        ...
        'geo_chemical_signatures': 'Regional anomalous amounts of Pb, Zn, Cu, Mo, Ag, Co, and Ni in insoluble residues. Zoning is roughly Cu C± Ni ± Co)-Pb-Zn-iron sulfide going up section; ores contain about 30 ppm Ag; inconsistent lateral separation of metal zones. Background for carbonates: Pb = 9 ppm; Zn = 20; Cu = 4.',
    }
}